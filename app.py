...
# --- Modulos de tabs ---
from tabs import tab_exploracion, tab_calidad, tab_graficos, tab_atipicos, tab_estandarizacion
...
if archivo is not None:
    ...
    with tab4:
        tab_atipicos.render(st.session_state[SESSION_KEY])

    with tab5:
        tab_estandarizacion.render(st.session_state[SESSION_KEY])
    ...
    col_c.markdown("**Graficos**\n\nHistograma+KDE, boxplot, violin, densidad, Q-Q plot, correlacion y mas.")
    col_d.markdown("**Datos Atipicos**\n\nCirculo de correlaciones, boxplot con percentiles, regla IQR y tabla de outliers.")
    col_e.markdown("**Centrar y Reducir**\n\nEstandarizacion Z-score, tabla de transformacion, distribucion antes/despues.")
